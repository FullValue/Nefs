      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-6 sm:mb-16 w-full max-w-[260px] sm:max-w-none mx-auto">
            {/* App Store Button */}
            <a href="https://apps.apple.com/fr/app/nefsy/id6763761659" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-black text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl flex items-center justify-center gap-2 sm:gap-3 hover:bg-gray-900 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
            ...
            {/* Google Play Button */}
            <a href="https://play.google.com/store/apps/details?id=com.marwann7.guideomra" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-black text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl flex items-center justify-center gap-2 sm:gap-3 hover:bg-gray-900 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
