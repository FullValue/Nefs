...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-0 lg:pt-40 overflow-hidden bg-pattern flex flex-col items-center text-center">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            {/* App Store Button */}
            <button className="bg-black text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-900 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              ...
              <div className="text-left">
                <div className="text-[10px] leading-none mb-1 uppercase tracking-wider">Télécharger sur l'</div>
            ...
            <button className="bg-black text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-gray-900 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
              ...
              <div className="text-left">
                <div className="text-[10px] leading-none mb-1 uppercase tracking-wider">Disponible sur</div>
      ...
      <div className="relative w-full max-w-5xl mx-auto h-[400px] sm:h-[500px] lg:h-[550px] mt-4">
  ...
  const steps = [
    {
      ...
      description: "Sélectionnez le type d'accompagnement souhaité : visite guidée, Omra Badal, ou assistance PMR."
    },
    {
